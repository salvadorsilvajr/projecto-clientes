...
class App extends Component {
   ...
   enviarCliente(e){
      ...
      if(this.state._id){
         ...
         .then(res => res.json())
         .then(data => {
            this.setState({mensaje: true, textoMsg: 'Cliente Actualizado',
            nombre:'', edad: '', telefono: '', empresa: '',_id: '', });
         ...
         .then(res => res.json())
         .then(data => {
            this.setState({mensaje: true, textoMsg:'Cliente Guardado',
            nombre:'', edad: '', telefono: '', empresa: '',});
            this.tiempoMensaje = setInterval(this.cerrarMensaje, 2000);
            this.obtenerClientes();
         }) 
         .catch(err => console.log(err));
   ...
   obtenerClientes(){
      fetch('/api/')
      .then(res => res.json())
      .then(data =>this.setState({clientes:data.clientes }) )
      .catch(err => console.log(err));
   }
   editarCliente(id){
      fetch('/api/' + id)
         ...
         <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
               <div className="container">
                  <a className="navbar-brand"  href="/">Proyecto Clientes</a>
               </div>
            </nav>
            <div className="container">
               <div className="row">
                           ...
                           <form onSubmit={this.enviarCliente}>
                              ...
                              <div className="row">
                                 <div className="form-group col-6">
                                    ...
                                    value={this.state.edad} onChange={this.handleChange} />
                                 </div>
                              </div>
                              <div className="row">
                                 <div className="form-group col-12">
                              ...
                              <div className="row">
                                 <div className="form-group col-12">
                                    ...
                                    value={this.state.empresa} onChange={this.handleChange}/>
                                 </div>
                              </div>
                              <div className="row">
                                 ...
                                 return(
                                    <tr key= {cliente._id}>
                                       ...
                                       <td className="row">
                                          ...
                                          onClick={() => this.editarCliente(cliente._id)}>
                                             <i className="tiny material-icons">edit</i> 
                                          </button>
                                          <button className="btn btn-primary btn-sm ml-2"onClick={() => this.eliminarCliente(cliente._id)}>
